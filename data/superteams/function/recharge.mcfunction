...
# Detect chip just placed in offhand (only when st_offhand=0)
execute if entity @s[scores={st_team=1,st_offhand=0}] if items entity @s weapon.offhand minecraft:echo_shard run scoreboard players set @s st_offhand 2
execute if entity @s[scores={st_team=2,st_offhand=0}] if items entity @s weapon.offhand minecraft:phantom_membrane run scoreboard players set @s st_offhand 2
execute if entity @s[scores={st_team=3,st_offhand=0}] if items entity @s weapon.offhand minecraft:heart_of_the_sea run scoreboard players set @s st_offhand 2
execute if entity @s[scores={st_team=4,st_offhand=0}] if items entity @s weapon.offhand minecraft:nautilus_shell run scoreboard players set @s st_offhand 2
execute if entity @s[scores={st_team=5,st_offhand=0}] if items entity @s weapon.offhand minecraft:prismarine_crystals run scoreboard players set @s st_offhand 2

# If st_offhand changed from 0 to 2, chip was just placed - recharge
execute if entity @s[scores={st_offhand=2}] run scoreboard players set @s st_buff_timer 18000
